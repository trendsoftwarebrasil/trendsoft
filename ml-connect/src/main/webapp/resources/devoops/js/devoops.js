...
function LoadCalendarScript(callback){
	function LoadFullCalendarScript(){
		if(!$.fn.fullCalendar){
			$.getScript('/ml-connect/javax.faces.resource/fullcalendar.js.xhtml?ln=devoops/plugins/fullcalendar', callback);
		}
		else {
	...
	if (!$.fn.moment){
		$.getScript('/ml-connect/javax.faces.resource/moment.min.js.xhtml?ln=devoops/plugins/moment', LoadFullCalendarScript);
	}
	else {
...
function LoadLeafletScript(callback){
	if (!$.fn.L){
		$.getScript('/ml-connect/javax.faces.resource/leaflet.js.xhtml?ln=devoops/plugins/leaflet', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadTimePickerScript(callback){
	if (!$.fn.timepicker){
		$.getScript('/ml-connect/javax.faces.resource/jquery-ui-timepicker-addon.min.js.xhtml?ln=devoops/plugins/jquery-ui-timepicker-addon', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadBootstrapValidatorScript(callback){
	if (!$.fn.bootstrapValidator){
		$.getScript('/ml-connect/javax.faces.resource/bootstrapValidator.min.js.xhtml?ln=devoops/plugins/bootstrapvalidator', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadSelect2Script(callback){
	if (!$.fn.select2){
		$.getScript('/ml-connect/javax.faces.resource/select2.min.js.xhtml?ln=devoops/plugins/select2', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadDataTablesScripts(callback){
	function LoadDatatables(){
		$.getScript('/ml-connect/javax.faces.resource/jquery.dataTables.js.xhtml?ln=devoops/plugins/datatables', function(){
			$.getScript('/ml-connect/javax.faces.resource/ZeroClipboard.js.xhtml?ln=devoops/plugins/datatables', function(){
				$.getScript('/ml-connect/javax.faces.resource/TableTools.js.xhtml?ln=devoops/plugins/datatables', function(){
					$.getScript('/ml-connect/javax.faces.resource/dataTables.bootstrap.js.xhtml?ln=devoops/plugins/datatables', callback);
				});
			});
		});
	}
...
function LoadFineUploader(callback){
	if (!$.fn.fineuploader){
		$.getScript('/ml-connect/javax.faces.resource/jquery.fineuploader-5.0.5.min.js.xhtml?ln=devoops/plugins/fineuploader', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadXChartScript(callback){
	function LoadXChart(){
		$.getScript('/ml-connect/javax.faces.resource/xcharts.min.js.xhtml?ln=devoops/plugins/xcharts', callback);
	}
	function LoadD3Script(){
		if (!$.fn.d3){
			$.getScript('/ml-connect/javax.faces.resource/d3.min.js.xhtml?ln=devoops/plugins/d3', LoadXChart)
		}
		else {
			LoadXChart();
		}
...
function LoadFlotScripts(callback){
	function LoadFlotScript(){
		$.getScript('/ml-connect/javax.faces.resource/jquery.flot.js.xhtml?ln=devoops/plugins/flot', LoadFlotResizeScript);
	}
	function LoadFlotResizeScript(){
		$.getScript('/ml-connect/javax.faces.resource/jquery.flot.resize.js.xhtml?ln=devoops/plugins/flot', LoadFlotTimeScript);
	}
	function LoadFlotTimeScript(){
		$.getScript('/ml-connect/javax.faces.resource/jquery.flot.time.js.xhtml?ln=devoops/plugins/flot', callback);
	}
	if (!$.fn.flot){
		LoadFlotScript();
	}
...
function LoadMorrisScripts(callback){
	function LoadMorrisScript(){
		if(!$.fn.Morris){
			$.getScript('/ml-connect/javax.faces.resource/morris.min.js.xhtml?ln=devoops/plugins/morris', callback);
		}
		else {
			if (callback && typeof(callback) === "function") {
				callback();
	...
	if (!$.fn.raphael){
		$.getScript('/ml-connect/javax.faces.resource/raphael-min.js.xhtml?ln=devoops/plugins/raphael', LoadMorrisScript);
	}
	else {
		LoadMorrisScript();
	}
...
function LoadAmchartsScripts(callback){
	function LoadAmchartsScript(){
		$.getScript('/ml-connect/javax.faces.resource/amcharts.js.xhtml?ln=devoops/plugins/amcharts', LoadFunnelScript);
	}
	function LoadFunnelScript(){
		$.getScript('/ml-connect/javax.faces.resource/funnel.js.xhtml?ln=devoops/plugins/amcharts', LoadSerialScript);
	}
	function LoadSerialScript(){
		$.getScript('/ml-connect/javax.faces.resource/serial.js.xhtml?ln=devoops/plugins/amcharts', LoadPieScript);
	}
	function LoadPieScript(){
		$.getScript('/ml-connect/javax.faces.resource/pie.js.xhtml?ln=devoops/plugins/amcharts', callback);
	}
	if (!$.fn.AmCharts){
		LoadAmchartsScript();
	}
...
function LoadChartistScripts(callback){
	function LoadChartistScript(){
		$.getScript('/ml-connect/javax.faces.resource/chartist.min.js.xhtml?ln=devoops/plugins/chartist', callback);
	}
	if (!$.fn.Chartist){
		LoadChartistScript();
	}
...
function LoadSpringyScripts(callback){
	function LoadSpringyScript(){
		...
		$.getScript('/ml-connect/javax.faces.resource/springy.js.xhtml?ln=devoops/plugins/springy', LoadSpringyUIScript);
	}
	function LoadSpringyUIScript(){
		$.getScript('/ml-connect/javax.faces.resource/springyui.js.xhtml?ln=devoops/plugins/springy', callback);
	}
	if (!$.fn.Springy){
		LoadSpringyScript();
	}
...
function LoadFancyboxScript(callback){
	if (!$.fn.fancybox){
		$.getScript('/ml-connect/javax.faces.resource/jquery.fancybox.js.xhtml?ln=devoops/plugins/fancybox', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadKnobScripts(callback){
	if(!$.fn.knob){
		$.getScript('/ml-connect/javax.faces.resource/jquery.knob.js.xhtml?ln=devoops/plugins/jQuery-Knob', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadSparkLineScript(callback){
	if(!$.fn.sparkline){
		$.getScript('/ml-connect/javax.faces.resource/jquery.sparkline.min.js.xhtml?ln=devoops/plugins/sparkline', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
